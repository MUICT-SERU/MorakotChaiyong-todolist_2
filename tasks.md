...
- [x] **3. Authentication - Sign Up & Login**
    - Store new users in `users.json`.
    - Allow existing users to log in with username and password.
    - Reject duplicate usernames.

- [x] **4. To-Do Management**
    - Create to-do items with title, details, priority, owner, and timestamps.
    - Edit to-do items (title, details, priority, status).
    - View all to-do items for the logged-in user.
    - View a specific to-do item's details.
